...
#define LCD_LAYER0_FRAME_BUFFER  ((uint32_t)0xD0500000)	//0xD0200000->0xD0500000, cndz, 20140627
#define LCD_LAYER1_FRAME_BUFFER  ((uint32_t)0xD0650000)	//0xD0400000->0xD0650000, cndz, 20140627
